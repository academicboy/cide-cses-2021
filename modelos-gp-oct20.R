###############################################
#Presentación de CSES para Política Y Gobierno#
###############################################
######Paquetes
library(pacman)
p_load(foreign, haven,dplyr,ggplot2, lme4)##Cargar con un solo comando todas las demás librerias
rm(list=ls(all=TRUE))
options(scipen = 999)
...
###Como no todos los estados están en la muestra de la entrevista, volvemos cero los efectos de lo estados que no están. 
